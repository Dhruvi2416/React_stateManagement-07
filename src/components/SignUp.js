        ...
        <div className="details d-flex  col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
          ...
          <form  onSubmit={formik.handleSubmit}>
            ...
            <div className="buttons d-flex">
              ...
              {/* this button also by default submits infact every buttons submits by default for html-form but due 
              to type or due to handleReset of it will reset every thing which is changed by formik's handleChange */}
